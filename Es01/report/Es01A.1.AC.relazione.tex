...
Non è stato possibile far convergere il fit con l'equazione
\eqref{eq:shockley} a dei valori ottimali se non restringendo l'intervallo
dei dati al di sotto di una tensione arbitraria 
$V\ped{lim} \approx \SI{1.77}{\V}$. Così facendo si ottengono i valori dei
parametri di best fit:
\begin{align*}
I_s &= 1.2045 \pm 0.0007  \; \si{m\A} \qquad &\rm{norm\_cov_{(I_s, \eta V_T)}} &= 0.998 \\
\eta_VT &= 44.53 \pm 0.04 \si{m\volt} \qquad &\rm{norm\_cov_{(I_s, I\ped{ofs})}} &= -0.170 \\
I\ped{ofs} &= 5722 \pm 1 \; \si{m\A} \qquad &\rm{norm\_cov_{(\eta V_T, I\ped{ofs})}} &= -0.168  \\ 

...
\begin{align}
t_H &= 1.03 \pm 0.02 \; \si{m\s} \\
t_L &= 1.12 \pm 0.02 \; \si{m\s} \\
T &= 2.14 \pm 0.01 \; \si{m\s} \\
\end{align}
...
Dato che $SR=11.1 \pm 0.3 \si{V/s}$ e che il salto tra $SAT_-$ e $SAT_+$ 
corrisponde circa a $8$V il periodo dell'onda deve valere come minimo 
$T_{min}\approx 1.5 \si{\micro\s}$ quindi $\tau = R_3 C_1$ deve essere $ >> T_{min}$.

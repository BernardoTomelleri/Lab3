...
\end{figure}
%TODO inserire il porcoddio di grafico e funzione di fit per l'intensità del campo magnetico in funzione della distanza dal centro, insomma quello che si è fatto con la sonda hall. Se si trova la funzione di fit c'è da aggiungere un offset dovuto al campo terrestre

# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 16:01:27 2022
...
if gen:
    ...
    data += noise
else: data = np.genfromtxt('C:/Users/rossi/OneDrive/Documenti/GitHub/Lab3/Es e-m/data/120.csv',  float, delimiter=',',

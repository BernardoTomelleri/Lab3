...
40 & $40.1 \pm 0.8$ & $383 \pm 3 \; \si{m}$ & $9.6 \pm 0.2$ \\
60 & $59.8 \pm 1.0$ & $576 \pm 4 \; \si{m}$ & $9.63 \pm 0.17$ \\
80 & $79.9 \pm 1.1$ & $768 \pm 5 \; \si{m}$ & $9.60 \pm 0.15$ \\
100 & $100.1 \pm 1.2$ & $960 \pm 6 \; \si{m}$ & $9.60 \pm 0.13$ \\
...
\begin{figure}[htb]
\centering
\includegraphics[scale=0.7]{gain}
...
\begin{align*}
\mathrm{intercetta} = -3 \pm 3 \; \si{m\V} \;\;\;\mathrm{pendenza} = 7.06 \pm 0.04 \;\;\;\mathrm{correlazione} 
= -0.71 \;\;\; \chi^2 = 9.7 \;\;\; d.o.f. = 8 \\
\text{coefficiente angolare/senza intercetta} = 7.03 \pm 0.03 \;\;\;
\chi^2 = 11.1 \;\;\; d.o.f. = 9
\end{align*}
...
\end{tabular} 
\caption{Misure di guadagno al variare della tensione in ingresso
all'amplificatore \label{tab: mes}}
\end{table}
...
\begin{figure}[htb]
\centering
\includegraphics[scale=0.5]{slewrate}
\caption{Fit lineare per l'andamento dell'uscita rispetto al segnale in

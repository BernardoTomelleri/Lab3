...
f_c &= \pm \; \si{\Hz} \, ; \quad f_A = \pm \; \si{k\Hz}
\end{align*}
...
dai valori misurati dei componenti dei circuiti è pari a
\begin{equation}
...
del segnale in ingresso, con ampiezza ridotta di circa la metà
$A_v = \nicefrac{v\ped{out}}{v\ped{in}} = \pm $, in accordo con
...
$A_v = \nicefrac{v\ped{out}}{v\ped{in}} = 0.537 \pm 0.008$, in accordo con
quanto ci aspettiamo.

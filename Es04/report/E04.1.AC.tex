...
discesa dell'onda abbiamo trovato una rampa come segnale in uscita, la cui
pendenza corrisponde proprio allo slew rate dell'amplificatore.
...
per il circuito derivatore $A_M = 20.02 \pm  0.09 \; \si{dB}$.
...
centro banda:
$f_c = 3408 \pm 11 \; \si{\Hz}$ e $f_A = 209.5 \pm 1.3 \; \si{k\Hz}$.
\begin{figure}[htb]
\centering
\includegraphics[scale=0.4]{hpfbode}
\caption{Plot di Bode ottenuto dallo scan con Network tra $\SI{100}{\Hz}$ e

...
%Attenuazioni sbagliate perché pensavo fossero alla frequenza di taglio
%TODO: Dio bestia
\end{array}
\]
...
\[
\abs{Z\ped{out, 1}} \leq \frac{1}{\omega C_2} \ll \frac{1}{\omega C_2} \leq 
\abs{Z\ped{in, 2}} \implies C_2 \ll C_1.
\]
Da confrontare con la scelta fatta di $C_2 \approx 10 \times C_1$.

...
%\lstinputlisting[label={list: semf-mealy}, style=Arduino, caption=Semaforo-mealy.ino]{../arduino/Semaforo.ino}
\begin{lstlisting}[label={list: semf}, style=Arduino, caption=semf-mealy.ino]
/*state
 * 0= ALL OFF
 * 1= RED ON
 * 2= RED YELLOW ON
...
\subsubsection{Edge-detector FSM di Moore}
...
\subsubsection{Edge-detector FSM di Mealy}
...
stato HIGH $(Q = 1)$, per cui OUT: $0 \to 1$ in maniera asincrona rispetto
clock.
\begin{figure}[htbp]
\centering
\begin{FSM}

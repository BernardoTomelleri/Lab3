...
\end{align*}
%TODO questi qua sotto vengono dal best fit, sono i risultati, gesù camioncino dei gelati
\begin{align*}
...
\end{align*}
%TODO Offset? cioè se fai una misura e dalla ricostruzione del segnale digitale ricavi Y (compreso tra 0 e 1) allora la misura in volt vale X=(Y-O)*C
\begin{align*}

...
\begin{minipage}{0.3\textwidth}
    ...
    \captionof{figure}{\label{fig: SN7404}Schema convertitore Gray-Binario}
\end{minipage}
\newline
...
\begin{minipage}{0.3\textwidth}
    ...
    \captionof{figure}{\label{fig: NAND}Schema circuitale del circuito integrato SN74LS00}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    ...
    \captionof{figure}{\label{XOR}Schema circuitale dell'integrato SN74LS86}
\end{minipage}
\newline
\begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{gb.png}
    \captionof{figure}{\label{gb}Schema convertitore Gray-Binario}
...
\begin{minipage}{0.5\textwidth}
    ...
    \captionof{figure}{\label{fig:halfadder}Schema logico di un half adder}
\end{minipage}
\begin{minipage}{0.5\textwidth}
	\includegraphics[width=\linewidth]{full.png}
    \captionof{figure}{\label{fig:fulladder}Schema logico di un full adder.}
\end{minipage}
...
\begin{figure}[htbp]
    ...
    \caption{\label{fig: ROM_sommatore}Acquisizione con logic dell'andamento dei vari segnali per il circuito Sommatore a 2 bit il cui risultato pilota la tabella di verità presente in \ref{fig: Ver}.}
     %I RUMENI SOTTO I TRENI DIO SCHIFOSO
\end{figure}
